...
class VerilogFactory {
    ...
    std::string getInternalDefinitionAssignSetMSB_as_m_over_4(const std::string operand);
    std::string getInternalDefinitionAssignSetMSB_as_m_times_2_over_4(const std::string operand);
    std::string getInternalDefinitionAssignSetMSB_as_m_times_3_over_4(const std::string operand);
    std::string getInternalDefinitionAssignSetMSB_as_m_minus_1_for_4_way_TCM(const std::string operand);
    std::string getInternalDefinitionAssignSetLSB_as_m_over_4(const std::string operand);
    std::string getInternalDefinitionAssignSetLSB_as_m_times_2_over_4(const std::string operand);
    std::string getInternalDefinitionAssignSetLSB_as_m_times_3_over_4(const std::string operand);
