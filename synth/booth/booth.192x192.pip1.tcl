...
set FILE_LIST {booth.192x192.pip1.v}
...
time_info
elaborate
write_hdl -generic > booth.192x192.pip1.generic.v
time_info
...
syn_opt
time_info
write_hdl > booth.192x192.pip1.mapped.v
report_area > booth.192x192.pip1.area.rpt
report_power > booth.192x192.pip1.power.rpt
report_timing > booth.192x192.pip1.timing.rpt
report_gates > booth.192x192.pip1.gates.rpt
report_runtime > booth.192x192.pip1.runtime.rpt
