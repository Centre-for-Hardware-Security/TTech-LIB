...
set FILE_LIST {booth.32x32.pip1.v}
...
time_info
elaborate
write_hdl -generic > booth.32x32.pip1.generic.v
time_info
...
syn_opt
time_info
write_hdl > booth.32x32.pip1.mapped.v
report_area > booth.32x32.pip1.area.rpt
report_power > booth.32x32.pip1.power.rpt
report_timing > booth.32x32.pip1.timing.rpt
report_gates > booth.32x32.pip1.gates.rpt
report_runtime > booth.32x32.pip1.runtime.rpt
