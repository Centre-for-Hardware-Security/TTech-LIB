...
set FILE_LIST {booth.32x32.pip2.v}
...
time_info
elaborate
write_hdl -generic > booth.32x32.pip2.generic.v
time_info
...
syn_opt
time_info
write_hdl > booth.32x32.pip2.mapped.v
report_area > booth.32x32.pip2.area.rpt
report_power > booth.32x32.pip2.power.rpt
report_timing > booth.32x32.pip2.timing.rpt
report_gates > booth.32x32.pip2.gates.rpt
report_runtime > booth.32x32.pip2.runtime.rpt
