...
set FILE_LIST {sbm_digitized.32x32.pip1.v}
...
time_info
elaborate
write_hdl -generic > sbm_digitized.32x32.pip1.generic.v
time_info
...
syn_opt
time_info
write_hdl > sbm_digitized.32x32.pip1.mapped.v
report_area > sbm_digitized.32x32.pip1.area.rpt
report_power > sbm_digitized.32x32.pip1.power.rpt
report_timing > sbm_digitized.32x32.pip1.timing.rpt
report_gates > sbm_digitized.32x32.pip1.gates.rpt
report_runtime > sbm_digitized.32x32.pip1.runtime.rpt
