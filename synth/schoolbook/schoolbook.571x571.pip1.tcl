...
set FILE_LIST {schoolbook.571x571.pip1.v}
...
time_info
elaborate
write_hdl -generic > schoolbook.571x571.pip1.generic.v
time_info
check_design -unresolved
set_time_unit -nanoseconds
set CLK_PORT_NAME clk
create_clock -name "fast" -period 2.51 $CLK_PORT_NAME
...
syn_opt
time_info
write_hdl > schoolbook.571x571.pip1.mapped.v
report_area > schoolbook.571x571.pip1.area.rpt
report_power > schoolbook.571x571.pip1.power.rpt
report_timing > schoolbook.571x571.pip1.timing.rpt
report_gates > schoolbook.571x571.pip1.gates.rpt
report_runtime > schoolbook.571x571.pip1.runtime.rpt
