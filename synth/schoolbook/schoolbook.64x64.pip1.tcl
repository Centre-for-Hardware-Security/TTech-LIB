...
set FILE_LIST {schoolbook.64x64.pip1.v}
...
time_info
elaborate
write_hdl -generic > schoolbook.64x64.pip1.generic.v
time_info
...
syn_opt
time_info
write_hdl > schoolbook.64x64.pip1.mapped.v
report_area > schoolbook.64x64.pip1.area.rpt
report_power > schoolbook.64x64.pip1.power.rpt
report_timing > schoolbook.64x64.pip1.timing.rpt
report_gates > schoolbook.64x64.pip1.gates.rpt
report_runtime > schoolbook.64x64.pip1.runtime.rpt
